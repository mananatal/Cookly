...
export const FileUpload = ({ onChange }) => {
  const [file, setFile] = useState(null); // Store only a single file
              ...
              >
                <div className="flex justify-between w-full items-center gap-4">
                  ...
                  <motion.p
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="rounded-lg px-2 py-1 w-fit text-sm text-neutral-600 dark:bg-neutral-800 dark:text-white shadow-input"
                  >
